...
public class VariablesTest {
   ...
   public String name = "instance variable"; //Instance V, Class level, Scope: Inside Class & Outside Method, memory:heap, To call we need obj
    static String staticName = "static variable"; //Static v, memory:class area, Instance Variable with Static Keyword, no obj creation is required

    public void m1(){
        int i = 0; //local varable, Scope: Method level, memory: stack, to call obj ref. method name, we access directly inside the method
